...
const captchaMiddleware = new CaptchaMiddleware(dbHandler);

// Basic Routes
router.get('/', authMiddleware.handleSession, basicRoutes.index);
router.get('/error', authMiddleware.handleSession, basicRoutes.error);

router.post('/login', captchaMiddleware.verifyToken, basicRoutes.login);
router.post('/logout', authMiddleware.handleSession, basicRoutes.logout);
router.post('/register', captchaMiddleware.verifyToken, inputMiddleware.handleRegistrationInput, userRoutes.register);
