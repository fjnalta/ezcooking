...
function checkUserPermission(req, res, next) {
    ...
    if (req.session !== undefined) {
        ...
        // if there is no valid login data for this page - redirect to error page
...
// Load Ingredients
router.get('/ingredients', handleSession, checkUserPermission, function (req, res) {
    let data;
    (async () => {
...
router.delete('/dish/:id', handleSession, checkUserPermission, function (req, res) {
    let data;
    // check db for login data
    (async () => {
