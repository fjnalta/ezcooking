 ...
 * Load Ingredients
 */
router.get('/ingredients', auth.handleSession, auth.checkUserLogin, function (req, res) {
    let data;
    (async () => {
...
router.post('/dish/:id', upload.single('data'), auth.handleSession, auth.checkUserLogin, function (req, res) {
    let val;
    (async () => {
        val = await dbHandler.updateDish(
            req.body.name,
            req.body.duration,
            req.body.shortDescription,
            req.file.filename,
 ...
 * @param DishId
 */
router.delete('/dish/:id', auth.handleSession, auth.checkUserLogin, function (req, res) {
    let data;
