...
// TODO - implement captchaMiddleware
...
router.get('/category', basicRoutes.categories);
router.get('/category/:category', dishRoutes.getSubCategories);
router.get('/category/:category/sub/:subcategory', dishRoutes.getDishesFromSubCategory);
