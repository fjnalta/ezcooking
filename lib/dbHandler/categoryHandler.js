...
class CategoryHandler {
    ...
    /*async function getCategories() {
        try {
            return await this.dbHandler.query({sql: "SELECT cc.id as cat_id, cc.name as catname, cs.id as sub_id, cs.subname  FROM category_subcategory as cs JOIN category_category cc on cs.category = cc.id"});
        } catch (e) {
            return "Error loading categories" + e;
        }
    }*/
