...
class CategoryHandler {
    ...
    getCategoryOverview = async () => {
        ...
        try {
            categoriesCount = await this.dbHandler.query({sql: "SELECT category_id, cc.name, COUNT(*) AS 'count' FROM dish_category JOIN category_category cc on dish_category.category_id = cc.id GROUP BY category_id"});
